...
<template>
  <div @touchmove.prevent>
    <div
      class="bg-indigo-400 w-full min-h-10 z-100 fixed" transition="all duration-300 ease-in-out"
    ...
    >
      ...
      <div
        ...
        items-center hover-class="bg-indigo-200 bg-opacity-50" :hover-stay-time="150" @click="closeActionSheet"
      >
        关闭
      </div>
    </div>
