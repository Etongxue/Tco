...
export const courseTimeList = [
  { s: '10:00', e: '10:45' }, { s: '10:55', e: '11:45' },
  { s: '12:00', e: '12:45' }, { s: '12:55', e: '13:40' },
  { s: '16:00', e: '16:45' }, { s: '16:55', e: '17:40' },
  { s: '18:10', e: '18:55' }, { s: '19:05', e: '19:50' },
  { s: '21:00', e: '21:45' }, { s: '21:55', e: '22:30' },
]
...
export const colorList = [
  ['#7B68EE', '#CE7CF4', '#FF7171', '#66CC99', '#9400D3', '#9400D3', '#6699CC', '#8A2BE2', '#669966', '#66CCFF', '#99CC66', '#FF9999', '#81CC74'],
  ['#9370DB', '#8A2BE2', '#CCCCFF', '#6A5ACD', '#A1D699', '#7397db', '#ff9983', '#87D7EB', '#6495ED'],
]
...
export const useCourseStore = defineStore(
  ...
  () => {
    ...
    function getCourseColor(courseItem: CourseModel): string {
      ...
      return colorMap.get(title) || 'bg-indigo'
    }
